...
public class Application {
	...
	@Transactional
	private static void firstUsers(UserRepository userRepository, ProductService productService, FactoryRepository factoryRepository) {
	...
	@Transactional
	private static void firstProducts(UserRepository userRepository, ProductService productService, FactoryRepository factoryRepository) {
	...
	@Bean
	public CommandLineRunner firstDatabaseLoad(UserRepository userRepository, ProductService productService, FactoryRepository factoryRepository) {
		return (args) -> {
			firstUsers(userRepository, productService, factoryRepository);
			firstProducts(userRepository, productService, factoryRepository);
		};
	}
